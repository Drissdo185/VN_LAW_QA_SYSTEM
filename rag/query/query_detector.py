...
from reasoning.prompts import PENALTY_QUERY_STANDARDIZATION_PROMPT
import json
import re
...
class QuerySimplifier:
    ...
    async def simplify_query(self, query: str) -> Dict[str, Any]:
        ...
        # Use the imported prompt template - now using PENALTY_QUERY_STANDARDIZATION_PROMPT
        prompt = PENALTY_QUERY_STANDARDIZATION_PROMPT.format(
            query=query,
